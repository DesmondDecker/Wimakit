  ...
  const renderProfile = () => (
    <ScrollView contentContainerStyle={{ padding: Spacing.lg, paddingBottom: 100 }}>
      ...
      {[
        ...
        { icon: 'power',                label: 'Log out',               onPress: () => {
          Alert.alert('Log Out', 'Are you sure?', [
            { text: 'Cancel', style: 'cancel' },
            {
              text: 'Log Out', style: 'destructive',
              // Previously this only called logout() and never navigated
              // anywhere — the store was cleared but the rider stayed on
              // this screen looking logged in until the next API call
              // failed and the response interceptor eventually bounced
              // them to welcome. Navigating immediately here matches how
              // the other two logout buttons in the app already behave.
              onPress: () => {
